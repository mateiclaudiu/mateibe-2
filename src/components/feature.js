...
const Feature = () => (
  <FeatureContainerStyled>
    <FeatureBlock color={"#424555"} title={"Frontend"} subtitle={""} link={"/onze-gemeenschap"} img={frontendImg}/>
    <FeatureBlock color={"#007a80"} title={"Backend"} subtitle={""} img={backendImg}/>
