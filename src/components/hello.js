...
export const Hello = () => (
  <div id="hello">
    ...
    <div style={{ fontFamily: "Poppins" }}>
      Hey! Nice to have you here. Let me introduce myself. I am Claudiu Matei, a freelance software developer with over five years of experience as a consultant for different big organisations in Belgium like DPG Media, Nobel Biocare, ABVV etc.
